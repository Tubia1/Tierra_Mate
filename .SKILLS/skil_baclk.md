...
No crear roles: las cuentas administrativas tienen el mismo acceso salvo queel usuario cambie expresamente esa decisión.
...
Si la prueba necesita Supabase real, mantener separadas las pruebas unitarias delas de integración y no introducir credenciales en el repositorio.
